...
class HomeServicesDetails extends StatefulWidget {
  @override
  _HomeServicesDetailsState createState() => _HomeServicesDetailsState();
}

class _HomeServicesDetailsState extends State<HomeServicesDetails> {
                          ...
                          child: Container(
                            decoration: BoxDecoration(
                                image: DecorationImage(
                                  image: AssetImage("assets/images/homeservice.jpg"),
                                  fit: BoxFit.cover,
                                )),
                          ),
                        ),
