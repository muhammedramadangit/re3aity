...
import 'package:re3aity/User/screens/SingleSection/Single_Section_Item.dart';
...
class SingleSection extends StatefulWidget {
  ...
  final int? id;
  final bool? skip;
  const SingleSection({this.serviceName, this.id, this.categoryData, required this.skip});
