...
class NetworkUtil {
  ...
  String base_url = 'https://my-care.life/api/';
  Dio dio = Dio();
  ...
  Future<Response> put(String url, {Map<String, dynamic>? headers, body, encoding}) {
    return dio
        .put(url,
        data: body,
        options: Options(headers: headers, requestEncoder: encoding))
  ...
  Response handleResponse(Response response) {
    ...
    if (statusCode == 401) {
      ...
      Response data = Response(
          ...
          statusCode: 500, requestOptions: response.requestOptions);
      return data;
