...
import 'package:lastre3ayty/Provider/Screens/Provider_Profile/Edit_Profile/Edit_Provider_Profile.dart';
                ...
                child: editCubit.image == null ? Container(
                  decoration: BoxDecoration(
                      image: DecorationImage(
                        image: NetworkImage(
                            "https://mycare.pro/public/dash/assets/img/${widget.providerProfileCubit.providerProfileModel.data.image}"),
                        fit: BoxFit.cover,
                      )),
