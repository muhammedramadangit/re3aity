...
import 'package:re3aity/Provider/Screens/MyReservation/Bloc/FinishedCubit/FinishedModel.dart';
import 'package:re3aity/Provider/Screens/MyReservation/Bloc/FinishedCubit/FinishedState.dart';
...
class FinishedCubit extends Cubit<FinishedState>{
  ...
  Future<void> finishedReservation(BuildContext context) async {
    ...
    try{
      final url = "https://my-care.life/api/upreservationtype";
      ...
      emit(FinishedErrorState(e.toString()));
    }
  }
}